...
public class PenjualanActivity extends Fragment {
	...
	private String[] data = { "Daftar Penjualan", "Input Penjualan" };
	private ArrayAdapter<String> adapter;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View v = inflater.inflate(R.layout.penjualan_activity, container, false);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (position == 0) {
					...
					// Adding a fragment to the fragment transaction
					ft.replace(R.id.content_frame, new PenjualanInputActivity());
